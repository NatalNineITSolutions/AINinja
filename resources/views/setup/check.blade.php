...
<div class="row mt-3 p-5" >
    ...
    @endif
        <ul class="list-group">
            ...
            <li class="list-group-item d-flex justify-content-between align-items-center">
                ...
                <p>{{__('Tokenizer PHP Extension')}}</p>
                <?php endif ?>
    ...
    @if ($allValuesAreTrue)
        <div class="offset-6 col-6 col-md-6">
            <a href="/setup/step-1" id="next"  class="btn btn-outline-danger mt-3 float-md-right">

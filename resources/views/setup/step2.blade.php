      ...
      <form id="dbform" action="{{route('setupStep2')}}" method="post">
         ...
         <div id="errormsg"></div>
            <div id="db_settings" class="form-group"></div>
                <label for="app_env">{{__('Select Database Type')}}</label>
                ...
                <label for="app_name" class="mt-1" id="db_host_label">{{__('DB Host')}}</label>
                <span 
                    class="tip" 
                    id="db1tooltip" 
                ...
                <label for="app_name" class="mt-1" id="db_port_label">{{__('DB Port')}}</label>
                ...
                <label for="app_name" class="mt-1" id="db_database_label">{{__('DB Database')}}</label> 
                ...
                <label for="app_name" class="mt-1" id="db_username_label">{{__('DB Username')}}</label> 
                ...
                <label for="app_name" class="mt-1" id="db_password_label">{{__('DB Password')}}</label> 
                ...
                >
                <a id="testdb" class="btn btn-dark mb-2 form-control mt-2 text-white">
                    {{__('Test Connection')}} <i class="fa fa-question-circle-o "></i>
                </a>
                <div class="row">
                    <div class="col-12 col-md-6">
                        <a href="/setup/step-1" class="btn btn-outline-danger mb-2">
                            <i class="fa fa-angle-left"></i> {{__('Previous Step')}}
                        </a>
                    </div>
                    <div class="col-12 col-md-6">
                        <button type="submit" class="btn btn-outline-danger mb-2  float-md-right next_step d-none">
